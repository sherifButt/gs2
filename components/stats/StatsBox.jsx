...
const StatsBox = () => {
   return (
      <div className='flex flex-row my-8 gap-5 justify-center items-center  mx-auto px-2 lg:px-[2.06rem] py-[1.63rem] bg-gray-600 rounded-[1.13rem]'>
         <div className='flex flex-row justify-between items-center w-full'>
            <div className='flex flex-col gap-1.5 justify-start items-center'>
               ...
               <p className='block uppercase text-center  text-md lg:text-lg text-white  font-light'>
                  Donations
               </p>
            </div>
            <div className='flex flex-col gap-1.5 justify-start items-center'>
