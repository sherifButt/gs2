   ...
   return (
      <div className='relative bg-gray-100  flex  grow z-0'>
         ...
         <div className='md:container mx-auto max-auto flex grow '>
            <div className=' flex flex-row mx-auto grow justify-center gap-4 flex-wrap md:flex-nowrap h-full max-w-lg pt-20  '>
               ...
               <div className='flex  grow  w-full  md:w-auto lg:w-350 mt-8  order-2 md:order-none ' ></div>
            </div>
         </div>
      </div>
   )
