...
const index = () => {
   return (
      <div class='flex flex-col gap-[1.88rem] justify-start items-center max-w-[31.44rem] mx-auto'>
         <div>
            <img
               class='block'
         ...
         <p class='block text-center text-2xl text-stone-800  font-medium'>
            Thank you for your donation! A receipt has been sent to your email.
         </p>
         <div>
            <p class='block text-xl text-black  font-medium'>
               Make an even bigger difference!
            </p>
         </div>
         <p class='block text-center text-sm text-black  font-light'>
         ...
         <div>
            {/* <div>
               ...
               />
               <p class='block text-center text-black  font-medium'>
                  COPY LINK
               </p>
            </div> */}
            {/* <div>
               <div>
                  ...
                  />
                  <p class='block opacity-50 text-black  font-light'>
         ...
         />
         <div>
            <p class='block text-[1.69rem] text-black  font-medium'>
               Download our app
            </p>
         </div>
         <p class='block w-[24.88rem] text-center text-sm text-black  font-light'>
