    ...
    <form className="divide-y mx-4 text-center">
      ...
      <div className="flex flex-col gap-3 justify-start items-center py-4 ">
        <div>
          ...
          <FieldRadialSelect
            data={campaignData?.defaultDonationSizes?.map((item, idx) => ({
              id: item.id,
              name: campaignData?.baseCurrency?.displaySymbol + item.value,
              value: item.value,
            }))}
            inputHandler={(e) => {
              setDonationAmount(e);
          ...
          <div>
            <div>
              ...
              <p className="block  text-center text-sm text-stone-800  ">
                GiveStar has a 0% platform fee on donations like these. Adding a
                small contribution on top of your donation means we can continue
                to support more charities and their incredible work.
              </p>
            </div>
            ...
            <FieldSelectVoluntaryContribution
              ...
              inputHandler={(e) => {
                ...
                setFormData({
                  ...
                  voluntaryContributionValueHolder: Number(e.target.value),
          ...
          <div>
            <div>
              ...
              <div className="flex flex-row gap-4 justify-center items-center mx-auto my-8">
                ...
                <img src="/assets/images/arrow.png" alt="" className="w-10" />
                <p className="text-2xl font-bold">
                  {formData.baseCurrency?.displaySymbol}
              ...
              <p className="block  text-center text-sm text-stone-800  ">
                I confirm that I am a UK taxpayer and I understand that if I pay
                ...
                my responsibility to pay the difference.
              </p>
            </div>
          </div>
      ...
      {giftAid && (
        <div className="flex flex-col gap-3 justify-start items-center py-8 ">
          <img className="mx-auto" src="/assets/images/giftaidit.png" alt="" />
          ...
          />
          <div
            hidden={!(formData?.gaCheckNoReturn && formData?.gaCheckOwnMoney)}>
            {" "}
            {/* Need both checkboxes for gift aid checked before we can proceed */}
        ...
        <div className="items-center py-8 ">
          ...
          <div
            ...
            <div className="flex flex-row justify-between ">
              ...
              <p>
                {formData?.baseCurrency?.displaySymbol}
                {(formData?.voluntaryContribution + formData.amount).toFixed(2)}
              </p>
            </div>
            <div className="flex flex-row justify-between">
          ...
          <div className="flex flex-col  p-8 pt-12  border rounded-3xl bg-gray-50 shadow-xl">
            ...
            {addDonationData?.data && (
              <SafeChargeCC
                ...
                merchantId={addDonationData?.data?.paymentResponse.merchantId}
                merchantSiteId={
