...
const CreateCampaignForm = () => {
  ...
  return (
    <div className="flex flex-col gap-6 ">
      <div
        className="flex items-center underline cursor-pointer self-start"
        onClick={() => router.back()}>
        <img className="h-4 mr-2" src="/assets/images/arrow-back.svg" />
        Back
      </div>

      <h1 className=" text-2xl sm:text-3xl text-left  mb-5 text-black  font-semibold">
        Create Campaign
      </h1>
      ...
      <FieldCombobox
        ...
        hidden={false}
      />
      <FieldLabel text="Tell us about your campaign" name="" forLabel="name" />
      <FieldText
        name="name"
        value={formData.name}
        description=""
